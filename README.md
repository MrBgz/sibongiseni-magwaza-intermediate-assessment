...
- deleting tasks
- weather dashboard (temperature, sunrise, sunset) powered by WeatherAPI
...
The Weather API client is unit-tested with HTTP calls stubbed to ensure the correct response.
